...
class SaltCallPrep(parsers.SaltCallOptionParser):
    '''
    Used to prepare opts in order to decide if need to stand up caller minion
    or use existing minion
    '''

    def prep(self):
        '''
        Do prep to get valid opts in self.config
        '''
        self.parse_args()
