...
class PublicKey(BaseKey):
    def __init__(self, *, path=None, key=None):
        ...
        try:
            self.key = serialization.load_pem_public_key(pub)
...
def verify_signature(key, message, signature, algorithm=PKCS1v15_SHA1):
    ...
    return PublicKey(path=key).verify(message, signature, algorithm)
...
class AsyncAuth:
    ...
    def minion_sign_in_payload(self):
        ...
        try:
            ...
            pub = PublicKey(path=pubkey_path)
