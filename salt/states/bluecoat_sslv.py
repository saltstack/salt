...
.. seealso::
    :ref:`bluecoat_sslv Proxy Module <salt.proxy.bluecoat_sslv>`
...
def distinguished_name_list_exists(name, items):
    ...
    try:
        ...
        if req_change:
            ...
            ret["changes"]["after"] = __salt__[
                "bluecoat_sslv.get_distinguished_name_list"
            ](name)
...
def ip_address_list_exists(name, items):
    ...
    try:
        ...
        if req_change:
            ret["changes"]["before"] = list_members
            ret["changes"]["after"] = __salt__["bluecoat_sslv.get_ip_address_list"](
                name
            )
