            ...
            if 'exists' in rt:
                if rt['exists']:
                    if route_table_id:
                        ...
                        route_table_desc = __salt__['boto_vpc.describe_route_tables'](route_table_id=route_table_id,
                                                                                      region=region,
                                                                                      key=key,
                                                                                      keyid=keyid,
                                                                                      profile=profile)
                        ...
                        route_table_found = True
                        route_table_desc = __salt__['boto_vpc.describe_route_tables'](route_table_name=route_table_name,
                                                                                      region=region,
                                                                                      key=key,
                                                                                      keyid=keyid,
                                                                                      profile=profile)
...
def _subnets_present(route_table_name, subnet_ids=None, subnet_names=None, tags=None, region=None, key=None, keyid=None, profile=None):
    ...
    if to_create or to_delete:
        ...
        new_sub = __salt__['boto_vpc.describe_route_tables'](route_table_name=route_table_name,
                                                             tags=tags,
                                                             region=region,
                                                             key=key,
                                                             keyid=keyid,
