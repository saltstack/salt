...
This is the "next gen" module for Windows 2012 servers or Windows 8 machines and above.
'''
...
def __virtual__():
    ...
    if osversion < 6.2:
        return (False, 'Can only load win_servermanager module on Windows 7 or Windows 2008 and later')

    return __virtualname__


def installed(name, recurse=False, force=False, management=False, restart=False):
    '''
    ...
    management:
        Install applicable management tools for the role
    ...
    ret['changes'] = {'feature': __salt__['win_servermanager.install'](name, recurse, management, restart)}
