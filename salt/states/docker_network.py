    ...
    *IPAM CONFIGURATION EXAMPLES*
    ...
    if network is not None:
        ...
        try:
            try:
                ...
                ret["comment"] = "Failed to inspect temp network: {}".format(str(exc))
                return ret
            else:
            ...
            try:
                ...
                ret.setdefault("warnings", []).append(
                    "Failed to remove temp network '{}': {}.".format(temp_net_name, exc)
                )
    ...
    if create_network:
        ...
        try:
            ...
            ret["comment"] = "Failed to create network '{}': {}".format(name, exc)
            return ret
        else:
