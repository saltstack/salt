...
def device_role(
    ...
    # The state should be able to use the return from this function to tell whether or not 
    # the minion is already in the desired state.
    required_changes = __salt__["netbox.check_device_role"](
        name,
        color=color,
        vm_role=vm_role,
        description=description
    ...
    if required_changes == False:
        ret["result"] = False
        ret["comment"] = "Something went wrong inside netbox.check_device_role"
        return ret
    ...
    if __opts__["test"] and not required_changes:
        ret["result"] = None
        ret["comment"] = "device_role {} would be created".format(name)
        ret["changes"] = {}
        return ret
    ...
    if required_changes == None:
        result = __salt__["netbox.create_device_role"](
            name,
            color=color,
            vm_role=vm_role,
            description=description
        ...
        if result == False:
            log.error("Unable to create device_role")
            return False

    if required_changes:
        result = __salt__["netbox.update_device_role"](
            name,
            **required_changes
        )
        if result == False:
            log.error("Unable to update device_role")
            return False
    ...
    # Just as in step 2, this function should be able to tell you by its 
    # return data whether or not changes need to be made.
    outstanding_changes = __salt__["netbox.check_device_role"](
        name,
        color=color,
        vm_role=vm_role,
        description=description
...
def manufacturer(
    ...
    # The state should be able to use the return from this function to tell whether or not 
    # the minion is already in the desired state.
    required_changes = __salt__["netbox.check_manufacturer"](
        name,
        description=description
    )
    if required_changes == False:
        ret["result"] = False
        ret["comment"] = "Something went wrong inside netbox.check_manufacturer"
        return ret
    ...
    if __opts__["test"] and not required_changes:
        ret["result"] = None
        ret["comment"] = "manufacturer {} would be created".format(name)
        ret["changes"] = {}
        return ret
    ...
    if required_changes == None:
        result = __salt__["netbox.create_manufacturer"](
            name,
            description=description
        )
        if result == False:
            log.error("Unable to create manufacturer")
            return False

    if required_changes:
        result = __salt__["netbox.update_manufacturer"](
            name,
            **required_changes
        )
        if result == False:
            log.error("Unable to update manufacturer")
            return False
    ...
    # Just as in step 2, this function should be able to tell you by its 
    # return data whether or not changes need to be made.
    outstanding_changes = __salt__["netbox.check_manufacturer"](
        name,
        description=description
    )
...
def device_type(
    ...
    # The state should be able to use the return from this function to tell whether or not 
    # the minion is already in the desired state.
    required_changes = __salt__["netbox.check_device_type"](
        name, # = model
    ...
    if required_changes == False:
        ret["result"] = False
        ret["comment"] = "Something went wrong inside netbox.check_device_type"
        return ret
    ...
    if __opts__["test"] and not required_changes:
        ret["result"] = None
        ret["comment"] = "device_type {} would be created".format(name)
        ret["changes"] = {}
        return ret
    ...
    if required_changes == None:
        result = __salt__["netbox.create_device_type"](
            name,
            manufacturer=manufacturer,
            part_number=part_number,
            u_height=u_height,
        ...
        if result == False:
            log.error("Unable to create device_type")
            return False

    if required_changes:
        result = __salt__["netbox.update_device_type"](
            name,
            **required_changes
        )
        if result == False:
            log.error("Unable to update device_type")
            return False
    ...
    # Just as in step 2, this function should be able to tell you by its 
    # return data whether or not changes need to be made.
    outstanding_changes = __salt__["netbox.check_device_type"](
        name, # = model
        manufacturer=manufacturer,
        part_number=part_number,
        u_height=u_height,
