            ...
            with salt.utils.fopen(bypass_file) as bypass_file_open:
                if bypass_file_contains in bypass_file_open.read():
                    return {
                        ...
                        "changes": {},
                        "result": True,
                        "comment": "pkg.installed was bypassed as {} was present in {}".format(
                            bypass_file_contains, bypass_file
                        ),
                    }
    if bypass_file is not None and bypass_file_contains is None:
        if os.path.isfile(bypass_file):
            return {
                ...
                "changes": {},
                "result": True,
                "comment": "pkg.installed was bypassed as bypass_file {} was present".format(
                    bypass_file
                ),
            }
