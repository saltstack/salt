...
def compile_template_str(template, renderers, default, blacklist, whitelist, jid=None):
    """
    ...
    return compile_template(fn_, renderers, default, blacklist, whitelist, jid=jid)
