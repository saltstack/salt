...
def gen_min(cachedir, extra_mods='', overwrite=False, so_mods='',
    ...
    min_files = (
        ...
        'salt/tgt/',
        'salt/tgt/__init__.py',
        'salt/tgt/compound.py',
        'salt/tgt/compound_pillar_exact.py',
        'salt/tgt/glob.py',
        'salt/tgt/grain.py',
        'salt/tgt/grain_pcre.py',
        'salt/tgt/ipcidr.py',
        'salt/tgt/list.py',
        'salt/tgt/nodegroup.py',
        'salt/tgt/pcre.py',
        'salt/tgt/pillar.py',
        'salt/tgt/pillar_exact.py',
        'salt/tgt/pillar_pcre .py',
        'salt/tgt/range.py',
        'salt/transport',
