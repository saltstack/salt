...
MACHINE_STATE_LIST = [
    ...
    (
        "Saved",
        "The machine is not currently running, but the execution state of the machine has been "
    ...
    (
        "Stuck",
        "Execution of the machine has reached the 'Guru Meditation' condition. This indicates a "
        "severe error in the hypervisor itself.",
    ),
    (
        "Teleporting",
        "The machine is about to be teleported to a different host or process. It is possible "
    ...
    (
        "LiveSnapshotting",
        "A live snapshot is being taken. The machine is running normally, but some "
    ...
    (
        "Stopping",
        "Machine is being normally stopped powering it off, or after the guest OS has initiated "
        "a shutdown sequence.",
    ),
    ("Saving", "Machine is saving its execution state to a file."),
    (
        "Restoring",
        "Execution state of the machine is being restored from a file after powering it on from "
