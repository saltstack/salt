    ...
    if set_del_root_vol_on_destroy:
        ...
        if rd_name is not None:
            ...
            if rd_name in dev_list:
                ...
                termination_key = spot_prefix + 'BlockDeviceMapping.{0}.Ebs.DeleteOnTermination'.format(dev_index)
                params[termination_key] = str(set_del_root_vol_on_destroy).lower()
            else:
                dev_index = len(dev_list)
                params[spot_prefix + 'BlockDeviceMapping.{0}.DeviceName'.format(dev_index)] = rd_name
                params[spot_prefix + 'BlockDeviceMapping.{0}.Ebs.DeleteOnTermination'.format(dev_index)] = str(
