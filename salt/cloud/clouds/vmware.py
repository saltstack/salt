...
def _manage_devices(devices, vm=None):
    ...
    if 'network' in list(devices.keys()):
        ...
        log.debug("Networks adapters to create: {0}".format(network_adapters_to_create)) if network_adapters_to_create else None
    ...
    if 'scsi' in list(devices.keys()):
        ...
        log.debug("SCSI controllers to create: {0}".format(scsi_controllers_to_create)) if scsi_controllers_to_create else None
    ...
    if 'ide' in list(devices.keys()):
        ...
        log.debug('IDE controllers to create: {0}'.format(ide_controllers_to_create)) if ide_controllers_to_create else None
    ...
    if 'disk' in list(devices.keys()):
        ...
        log.debug("Hard disks to create: {0}".format(disks_to_create)) if disks_to_create else None
    ...
    if 'cd' in list(devices.keys()):
        ...
        log.debug("CD/DVD drives to create: {0}".format(cd_drives_to_create)) if cd_drives_to_create else None
