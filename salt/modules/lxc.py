...
def init(name,
    ...
    if users is None:
        users = []
    dusers = ['root']
    # think to touch the default user generated by default ubuntu template which
    # has a really unsecure password too ...
...
def read_conf(conf_file, out_format='simple'):
    ...
    .. code-block:: bash
        ...
        salt 'minion' lxc.read_conf /etc/lxc/mycontainer.conf out_format=comented
    '''
    ret_commented = []
    ret_simple = {}
