...
def _gen_key_input(**kwargs):
    """
    Generate --gen-key input per gpg doc/DETAILS

    This code is from python-gnupg 0.4.7dev0 it's here because Saltstack
    supports many different systems and each one have different versions of
    python-gnupg, with different features. Also, by now (2021-02-09) this
    code isn't even released.
...
def create_key(
    ...
    input_data = _gen_key_input(**create_params)
