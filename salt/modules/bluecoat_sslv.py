...
.. seealso::
    :ref:`Blue Coat SSL Visibility Proxy Module <salt.proxy.bluecoat_sslv>`
...
def __virtual__():
    ...
    return (
        False,
        "The bluecoat_sslv execution module can only be loaded for bluecoat_sslv proxy minions.",
    )
