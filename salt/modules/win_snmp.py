...
def get_agent_settings():
    ...
    ret["services"] = list()
    ret["contact"] = (__salt__["reg.read_value"](_HKEY, _AGENT_KEY, "sysContact"))[
        "vdata"
    ]

    ret["location"] = (__salt__["reg.read_value"](_HKEY, _AGENT_KEY, "sysLocation"))[
        "vdata"
    ]

    current_bitmask = (__salt__["reg.read_value"](_HKEY, _AGENT_KEY, "sysServices"))[
        "vdata"
    ]
...
def get_community_names():
    ...
    if __salt__["reg.key_exists"](_HKEY, _COMMUNITIES_GPO_KEY):
        ...
        current_values = __salt__["reg.list_values"](_HKEY, _COMMUNITIES_GPO_KEY)
    ...
    if not ret:
        ...
        current_values = __salt__["reg.list_values"](_HKEY, _COMMUNITIES_KEY)
