...
def unzip_cmd(zip_file, dest, excludes=None, template=None, options=None, runas=None):
    '''
...
def _render_filenames(filenames, zip_file, saltenv, template):
    '''
    Process markup in the :param:`filenames` and :param:`zip_file` variables (NOT the
