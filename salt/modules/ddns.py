...
def update(
    ...
    **kwargs
    ...
    if keyring is None:
        log.warning(
            "Insecure dns configuration detected! Keyring is not provided in configuration."
        )

    if keyname is None:
        log.warning(
            "Insecure dns configuration detected! Keyname is not provided in configuration."
        )
