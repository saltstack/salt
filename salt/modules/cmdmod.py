    ...
    **kwargs
    ...
    if not salt.utils.platform.is_windows():
        ...
        if windows_codepage:
            ...
            previous_windows_codepage = salt.utils.win_chcp.get_page_id()
    ...
    if not use_vt:
        ...
        try:
            if change_windows_codepage:
                salt.utils.win_chcp.set_page_id(windows_codepage)
            try:
            ...
            if change_windows_codepage:
                salt.utils.win_chcp.set_page_id(previous_windows_codepage)
