...
def sync_all(saltenv='base', extmod_whitelist=None, extmod_blacklist=None):
    ...
    ret['liquid'] = sync_liquid(saltenv=saltenv, extmod_whitelist=extmod_whitelist, extmod_blacklist=extmod_blacklist)
...
def sync_liquid(saltenv='base', extmod_whitelist=None, extmod_blacklist=None):
    '''
    .. versionadded:: Oxygen

    Sync Liquid modules from ``salt://_liquid`` to the master
    ...
    .. code-block:: bash
        ...
        salt-run saltutil.sync_liquid
    '''
    return salt.utils.extmods.sync(__opts__, 'liquid', saltenv=saltenv, extmod_whitelist=extmod_whitelist,
                                   extmod_blacklist=extmod_blacklist)[0]
