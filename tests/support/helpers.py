    ...
    def decorator(func):
        ...
        def wrap(cls):
            ...
            if not create_user:
                ...
                if on_existing == "skip":
                    cls.skipTest("Failed to create system user '{0}'".format(username))
    ...
    def decorator(func):
        ...
        def wrap(cls):
            ...
            if not create_group:
                ...
                if on_existing == "skip":
                    cls.skipTest("Failed to create system group '{0}'".format(group))
