                ...
                if delete:
                    ...
                    if not delete_user:
                        if failure is None:
                            ...
                            log.warning(
                                "The test-case failed and also did the removal of the system user %r",
                                username,
                            )
            ...
            try:
                ...
                if delete:
                    ...
                    if not delete_group:
                        if failure is None:
                            log.warning(
                                "Although the actual test-case did not fail, deleting the created system group %r "
                                "afterwards did.",
                                group,
                            )
                        else:
                            log.warning(
                                "The test-case failed and also did the removal of the system group %r",
                                group,
                            )
                if failure is not None:
                    # If an exception was thrown, raise it
            ...
            try:
                ...
                if delete:
                    ...
                    if not delete_user:
                        if failure is None:
                            log.warning(
                                "Although the actual test-case did not fail, deleting the created system user %r "
                                "afterwards did.",
                                username,
                            )
                        else:
