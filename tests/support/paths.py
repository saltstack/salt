...
ROOT_DIR = os.path.join(TMP, 'rootdir')
SRC_FILES = os.path.join(INTEGRATION_TEST_DIR, 'files')
...
TMP_STATE_TREE = os.path.join(ROOT_DIR, 'salt-temp-state-tree')
TMP_PILLAR_TREE = os.path.join(ROOT_DIR, 'salt-temp-pillar-tree')
TMP_PRODENV_STATE_TREE = os.path.join(ROOT_DIR, 'salt-temp-prodenv-state-tree')
TMP_CONF_DIR = os.path.join(ROOT_DIR, 'config')
