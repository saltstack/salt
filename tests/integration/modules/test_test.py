...
class TestModuleTest(ModuleCase, AdaptedConfigurationTestCaseMixin):
    ...
    def test_echo(self):
        ...
        test.echo
        '''
        assert self.run_function('test.echo', ['text']) == 'text'

    def test_version(self):
        '''
        test.version
        '''
        assert self.run_function('test.version') == \
    ...
    def test_conf_test(self):
        ...
        test.conf_test
        '''
        assert self.run_function('test.conf_test') == 'baz'
    ...
    def test_get_opts(self):
        ...
        assert self.run_function('test.get_opts')['cachedir'] == \
            opts['cachedir']
    ...
    def test_outputter(self):
        ...
        test.outputter
        '''
        assert self.run_function('test.outputter', ['text']) == 'text'
