...
class DataModuleTest(integration.ModuleCase):
    ...
    def test_get_update(self):
        ...
        self.assertEqual(self.run_function('data.getval', ['spam']),'eggs')

        self.assertTrue(self.run_function('data.update', ['unladen', 'swallow']))
        self.assertEqual(self.run_function('data.getvals', ['["spam", "unladen"]']), ['eggs', 'swallow'])
        self._clear_db()
    ...
    def test_cas_update(self):
        ...
        self.assertEqual(self.run_function('data.getval', ['spam']), 'green')
