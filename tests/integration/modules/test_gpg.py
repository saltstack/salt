...
class GpgTestCase(ModuleCase):
    ...
    def tearDownClass(cls):
        try:
            ...
            if exc.errno != errno.ENOENT:
                raise
        del cls.gnupghome
        del cls.gpg1_secret_key_spec
        del cls.gpg2_secret_key_spec
        del cls.secret_key
    ...
    def step_03a_list_keys(self):
        ...
        self.assertEqual(res, [self.gpg2_secret_key_spec])
    ...
    def step_03b_list_secret_keys(self):
        ...
        if salt.utils.versions.version_cmp(GPG_VERSION, '2.0') >= 0:
            ...
            self.assertEqual(res, [self.gpg1_secret_key_spec])
