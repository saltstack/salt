...
class MacXattrModuleTest(ModuleCase):
    ...
    def test_list_no_xattr(self):
        ...
        assert self.run_function('xattr.clear', [self.test_file])

        # Test no attributes
        assert self.run_function('xattr.list', [self.test_file]) == {}

        # Test file not found
        assert self.run_function('xattr.list', [self.no_file]) == \
    ...
    def test_write(self):
        ...
        assert self.run_function('xattr.write',
        ...
        # Test file not found
        assert self.run_function('xattr.write', [self.no_file, 'patrick', 'jellyfish']) == \
            'ERROR: File not found: {0}'.format(self.no_file)
    ...
    def test_read(self):
        ...
        # Read the attribute
        assert self.run_function('xattr.read', [self.test_file, 'spongebob']) == \
            'squarepants'

        # Test file not found
        assert self.run_function('xattr.read', [self.no_file, 'spongebob']) == \
            'ERROR: File not found: {0}'.format(self.no_file)

        # Test attribute not found
        assert self.run_function('xattr.read', [self.test_file, 'patrick']) == \
    ...
    def test_delete(self):
        ...
        # Delete an attribute
        assert self.run_function('xattr.delete', [self.test_file, 'squidward'])
        ...
        # Test file not found
        assert self.run_function('xattr.delete', [self.no_file, 'spongebob']) == \
            'ERROR: File not found: {0}'.format(self.no_file)

        # Test attribute not found
        assert self.run_function('xattr.delete', [self.test_file, 'patrick']) == \
            'ERROR: Attribute not found: patrick'
    ...
    def test_clear(self):
        ...
        # Test file not found
        assert self.run_function('xattr.clear', [self.no_file]) == \
                         'ERROR: File not found: {0}'.format(self.no_file)
