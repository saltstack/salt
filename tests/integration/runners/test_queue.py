...
class ManageTest(ShellCase):
    ...
    def test_queue_list(self):
        ...
        self.assertEqual(ret['return'],
                         [u'a', u'b', u'e', u'r', u'z'],
                         msg='queue item list not returned as expected ("{0}" returned)'.format(ret['return']))
    ...
    def test_queue_pop(self):
        ...
        self.assertEqual(ret['return'],
                         expected_return,
                         msg='Item returned from queue "{0}" not the expected item "{1}"'.format(ret['return'], expected_return))
    ...
    def test_queue_process(self):
        ...
        self.assertEqual(ret['return']['items'],
                        [u'a', u'b'],
                        msg='Items returned from process queue runner not as expected (items returned "{0}")'.format(ret['return']['items']))
