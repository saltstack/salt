...
class FileserverTest(ShellCase):
    ...
    def test_dir_list(self):
        ...
        assert isinstance(ret['return'], list)
        assert '_modules' in ret['return']
    ...
    def test_clear_file_list_cache(self):
        ...
        with gen_cache():
            ...
            assert ret['return'] == {'roots': saltenvs}
    ...
    def test_file_list(self):
        ...
        assert isinstance(ret['return'], list)
        assert 'grail/scene33' in ret['return']
