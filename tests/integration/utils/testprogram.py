...
class TestProgram(object):
    ...
    def __init__(self, program=None, name=None, env=None, shell=False, parent_dir=None, clean_on_exit=True, **kwargs):
        ...
        self.config_attrs = kwargs.pop('config_attrs', copy.copy(self.config_attrs))
        self.config_vals = kwargs.pop('config_vals', copy.copy(self.config_vals))
        self.config_base = kwargs.pop('config_base', copy.copy(self.config_base))
        self.configs = kwargs.pop('configs', copy.copy(self.configs))
    ...
    def config_file_get(self, config):
        ...
        return self.configs[config].get('path', os.path.join(self.config_dir, config))
    ...
    def config_subs(self):
        ...
        LOG.debug('TLH: config_subs({0}) => {1}'.format(self.name, subs))
        return subs
    ...
    def config_stringify(self, config):
        ...
        LOG.debug('TLH: stringify({0},{1}) => {2}'.format(self.name, config, cfg))
        return cfg
...
class TestSaltProgram(TestProgram):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'config_base' in kwargs:
            kwargs['config_base'] = self.config_merge(self.config_base, kwargs['config_base'])
    ...
    def config_stringify(self, config):
        ...
        LOG.debug('TLH: stringify({0},{1}) => {2}'.format(self.name, config, scfg))
        return scfg
