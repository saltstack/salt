...
class TestDaemon(object):
    ...
    def transplant_configs(cls, transport='zeromq'):
        ...
        directories = [
            (os.path.join(master_opts['pki_dir'], 'minions'), None),
            (os.path.join(master_opts['pki_dir'], 'minions_pre'), None),
            (os.path.join(master_opts['pki_dir'], 'minions_rejected'), None),
            (os.path.join(master_opts['pki_dir'], 'minions_denied'), None),
            (os.path.join(master_opts['cachedir'], 'jobs'), None),
            (os.path.join(master_opts['cachedir'], 'raet'), None),
            (os.path.join(master_opts['root_dir'], 'cache', 'tokens'), None),
            (os.path.join(syndic_master_opts['pki_dir'], 'minions'), None),
            (os.path.join(syndic_master_opts['pki_dir'], 'minions_pre'), None),
            (os.path.join(syndic_master_opts['pki_dir'], 'minions_rejected'), None),
            (os.path.join(syndic_master_opts['cachedir'], 'jobs'), None),
            (os.path.join(syndic_master_opts['cachedir'], 'raet'), None),
            (os.path.join(syndic_master_opts['root_dir'], 'cache', 'tokens'), None),
            (os.path.join(master_opts['pki_dir'], 'accepted'), None),
            (os.path.join(master_opts['pki_dir'], 'rejected'), None),
            (os.path.join(master_opts['pki_dir'], 'pending'), None),
            (os.path.join(syndic_master_opts['pki_dir'], 'accepted'), None),
            (os.path.join(syndic_master_opts['pki_dir'], 'rejected'), None),
            (os.path.join(syndic_master_opts['pki_dir'], 'pending'), None),
            (os.path.join(syndic_master_opts['cachedir'], 'raet'), None),
            (os.path.join(minion_opts['pki_dir'], 'accepted'), None),
            (os.path.join(minion_opts['pki_dir'], 'rejected'), None),
            (os.path.join(minion_opts['pki_dir'], 'pending'), None),
            (os.path.join(minion_opts['cachedir'], 'raet'), None),
            (os.path.join(sub_minion_opts['pki_dir'], 'accepted'), None),
            (os.path.join(sub_minion_opts['pki_dir'], 'rejected'), None),
            (os.path.join(sub_minion_opts['pki_dir'], 'pending'), None),
            (os.path.join(sub_minion_opts['cachedir'], 'raet'), None),
            (os.path.dirname(master_opts['log_file']), None),
            (minion_opts['extension_modules'], None),
            (sub_minion_opts['extension_modules'], None),
            (sub_minion_opts['pki_dir'], None),
            (master_opts['sock_dir'], None),
            (syndic_master_opts['sock_dir'], None),
            (sub_minion_opts['sock_dir'], None),
            (minion_opts['sock_dir'], None),
            (RUNTIME_VARS.TMP_STATE_TREE, None),
            (RUNTIME_VARS.TMP_PRODENV_STATE_TREE, None),
            (TMP, None)
        ]
        verify_env(
            dirs=directories,
