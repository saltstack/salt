...
def test_wheel(virtualenv, cache_dir, use_static_requirements, src_dir):
    ...
    with virtualenv as venv:
        ...
        ## # DGM this needs to be changed to using python -m build
        ## venv.run(venv.venv_python, "setup.py", "clean", cwd=src_dir)
        print(f"DGM test_wheel entry cache_dir '{cache_dir}', src_dir '{src_dir}'")
        ## DGM shutil.rmtree(cache_dir, ignore_errors=False)
        venv.run(
            venv.venv_python,
            "-m",
            "build",
        ...
        print(f"DGM test_wheel salt_generated_package '{salt_generated_package}'")
        ...
        print(f"DGM test_wheel whl_ver_cmp '{whl_ver_cmp}'")
        ...
        print(f"DGM test_wheel check installed version '{installed_version}'")
        ...
        print(
            f"DGM test_wheel first installed_salt_path '{installed_salt_path }', subdir '{subdir}'"
        )
        installed_salt_path = installed_salt_path.joinpath(*subdir)
        print(f"DGM test_wheel first installed_salt_path '{installed_salt_path }'")
        assert installed_salt_path.is_dir()

        # DGM setuptool doesn't generate _version.py, this file was generated by setup.py
        salt_generated_version_file_path = installed_salt_path / "_version.py"
        print(
            f"DGM test_wheel salt_generated_version_file_path '{salt_generated_version_file_path}'"
        )
