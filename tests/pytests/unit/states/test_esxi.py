...
@pytest.mark.parametrize(
    "kw_key,kw_value",
    [("ssh_key", "TheSSHKeyFile"), ("ssh_key_file", "TheSSHKeyFile")],
)
@pytest.mark.parametrize("certificate_verify_value", (None, True, False))
def test_certificate_verify(kw_key, kw_value, certificate_verify_value):
