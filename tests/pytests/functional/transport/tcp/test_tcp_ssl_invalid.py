"""
Tests for TCP transport SSL/TLS with invalid certificates.

These tests verify that TCP transport properly rejects invalid certificates
...
async def test_tcp_client_invalid_cert_rejected(
    io_loop,
    minion_opts,
    master_opts,
    process_manager,
    ...
    """
    Test that TCP server rejects client with certificate signed by wrong CA.
...
async def test_tcp_server_invalid_cert_rejected(
    io_loop,
    minion_opts,
    master_opts,
    process_manager,
    ...
    """
    Test that TCP client rejects server with certificate signed by wrong CA.
...
async def test_tcp_client_no_cert_rejected(
    io_loop,
    minion_opts,
    master_opts,
    process_manager,
    ...
    """
    Test that TCP server rejects client without certificate.
...
def test_tcp_invalid_cert_chain_detected(ssl_ca_cert_key, ssl_invalid_server_cert_key):
    """
...
def test_tcp_invalid_ca_detected(ssl_ca_cert_key, ssl_invalid_ca_cert_key):
    """
