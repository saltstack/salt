...
@pytest.mark.parametrize(
    ...
    [
        (
            "DisableDomainCreds",
             "Enabled", "HKLM", "SYSTEM\\CurrentControlSet\\Control\\Lsa",
             "DisableDomainCreds", 1, "REG_DWORD", False,
        ),
        (
            "Network access: Do not allow storage of passwords and credentials "
            "for network authentication",
            "Disabled", "HKLM", "SYSTEM\\CurrentControlSet\\Control\\Lsa",
            "DisableDomainCreds", 0, "REG_DWORD", False,
        ),
        (
            "DisableDomainCreds",
            "Not Defined", "HKLM", "SYSTEM\\CurrentControlSet\\Control\\Lsa",
            "DisableDomainCreds", 1, None, True,
        ),
        (
            "ForceGuest",
        ...
        (
            ...
            "ScRemoveOption", "0", "REG_SZ", False,
        ),
        (
            "Interactive logon: Smart card removal behavior",
            "Lock Workstation",
            "HKLM", "Software\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",
            "ScRemoveOption", "1", "REG_SZ", False,
        ),
        (
            "ScRemoveOption",
            "Not Defined",
            "HKLM", "Software\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",
            "ScRemoveOption", "0", "REG_SZ", True,
        ),
    ]
)
def test_reg_policy(
