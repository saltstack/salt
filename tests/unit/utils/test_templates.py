...
class RenderTestCase(TestCase):
    ...
    def test_render_jinja_sanity(self):
        tmpl = '''OK'''
        res = salt.utils.templates.render_jinja_tmpl(tmpl, dict(context))
    ...
    def test_render_mako_sanity(self):
        tmpl = '''OK'''
        res = salt.utils.templates.render_mako_tmpl(tmpl, dict(context))
        self.assertEqual(res, 'OK')
    ...
    def test_render_wempy_sanity(self):
        tmpl = '''OK'''
        res = salt.utils.templates.render_wempy_tmpl(tmpl, dict(context))
        self.assertEqual(res, 'OK')
    ...
    def test_render_genshi_sanity(self):
        tmpl = '''<RU>OK</RU>'''
        res = salt.utils.templates.render_genshi_tmpl(tmpl, dict(context))
        self.assertEqual(res, '<RU>OK</RU>')
    ...
    def test_render_cheetah_sanity(self):
        tmpl = '''OK'''
        res = salt.utils.templates.render_cheetah_tmpl(tmpl, dict(context))
        self.assertEqual(res, 'OK')
