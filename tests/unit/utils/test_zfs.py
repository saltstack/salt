...
class ZfsUtilsTestCase(TestCase):
    ...
    def test_from_size_decimal(self):
        '''
        Test from_size with '4.2M'
        '''
        self.assertEqual(zfs.from_size('4.2M'), 4404019)
        self.assertEqual(zfs.from_size(zfs.from_size('4.2M')), 4404019)
    ...
    def test_to_size_str_decimal(self):
        ...
        '''
        self.assertEqual(zfs.to_size('4404019'), '4.2M')
        self.assertEqual(zfs.to_size(zfs.to_size('4404019')), '4.2M')
