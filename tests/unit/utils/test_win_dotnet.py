...
class WinDotNetTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.mock_reg_exists = MagicMock(
            side_effect=[True,  # Version exists in v2.0.50727
        ...
        self.mock_reg_read = MagicMock(
            side_effect=[
                # v2.0.50727
                {'vdata': 1}, {'vdata': '2.0.50727.4927'}, {'vdata': 2},
                # v3.0
                {'vdata': 1}, {'vdata': '3.0.30729.4926'}, {'vdata': 2},
                # v3.5
                {'vdata': 1}, {'vdata': '3.5.30729.4926'}, {'vdata': 1},
                # v4
                {'vdata': 1}, {'vdata': 461814},
            ]
        )
