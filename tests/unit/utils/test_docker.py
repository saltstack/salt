...
class TranslateContainerInputTestCase(TranslateBase):
    ...
    def test_port_bindings(self):
        ...
        bindings = (
            ...
            '[fd00:7::8:9]:15507-15508:5507-5508/udp'
        )
        for val in (bindings, bindings.split(',')):
            self.assertEqual(
                ...
                {'port_bindings': {80: [('10.1.2.3', 8080),
                                        ...
                                        ('fd00:1::2:3', 8888)],
                                   3333: ('10.4.5.6', 3333),
                                   3335: ('fd00:4::5:6', 3335),
                                   4505: ('10.7.8.9', 14505),
                                   4506: ('10.7.8.9', 14506),
                                   4507: ('fd00:7::8:9', 14507),
                                   4508: ('fd00:7::8:9', 14508),
                                   '81/udp': [('10.1.2.3', 8080),
                                              ('10.1.2.3', 8888),
                                              ('fd00:1::2:3', 8080),
                                              ('fd00:1::2:3', 8888)],
                                   '3334/udp': ('10.4.5.6', 3334),
                                   '3336/udp': ('fd00:4::5:6', 3336),
                                   '5505/udp': ('10.7.8.9', 15505),
                                   '5506/udp': ('10.7.8.9', 15506),
                                   '5507/udp': ('fd00:7::8:9', 15507),
                                   '5508/udp': ('fd00:7::8:9', 15508)},
                 'ports': [80, 3333, 3335, 4505, 4506, 4507, 4508,
                           (81, 'udp'), (3334, 'udp'), (3336, 'udp'),
                           (5505, 'udp'), (5506, 'udp'),
                           (5507, 'udp'), (5508, 'udp')]}
            )
        ...
        for val in (bindings, bindings.split(',')):
            self.assertEqual(
                ...
                {'port_bindings': {80: [('10.1.2.3',), ('10.1.2.3',), ('fd00:1::2:3',), ('fd00:1::2:3',)],
                                   3333: ('10.4.5.6'),
                                   3334: ('fd00:4::5:6'),
                                   4505: ('10.7.8.9',),
                                   4506: ('10.7.8.9',),
                                   4507: ('fd00:7::8:9',),
                                   4508: ('fd00:7::8:9',),
                                   '81/udp': [('10.1.2.3',), ('10.1.2.3',), ('fd00:1::2:3',), ('fd00:1::2:3',)],
                                   '3334/udp': ('10.4.5.6',),
                                   '3335/udp': ('fd00:4::5:6',),
                                   '5505/udp': ('10.7.8.9',),
                                   '5506/udp': ('10.7.8.9',),
                                   '5507/udp': ('fd00:7::8:9',),
                                   '5508/udp': ('fd00:7::8:9',)},
                 'ports': [80, 3333, 4505, 4506, 4507, 4508,
                           (81, 'udp'), (3334, 'udp'), (3336, 'udp'),
                           (5505, 'udp'), (5506, 'udp'),
                           (5507, 'udp'), (5508, 'udp')]}
            )
