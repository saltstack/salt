...
class Boto3modTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_set_and_get_with_no_auth_params(self):
        boto3mod.cache_id(SERVICE, RESOURCE_NAME, resource_id=RESOURCE_ID)
        self.assertEqual(boto3mod.cache_id(SERVICE, RESOURCE_NAME), RESOURCE_ID)
    ...
    def test_set_and_get_with_explicit_auth_params(self):
        ...
        self.assertEqual(
            boto3mod.cache_id(SERVICE, RESOURCE_NAME, **CONN_PARAMETERS), RESOURCE_ID
        )
    ...
    def test_set_and_get_with_different_region_returns_none(self):
        ...
        self.assertEqual(
            boto3mod.cache_id(SERVICE, RESOURCE_NAME, region="us-west-2"), None
        )
    ...
    def test_set_and_get_after_invalidation_returns_none(self):
        ...
        self.assertEqual(boto3mod.cache_id(SERVICE, RESOURCE_NAME), None)

    def test_partial(self):
        cache_id = boto3mod.cache_id_func(SERVICE)
