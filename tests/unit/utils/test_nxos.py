...
from salt.exceptions import CommandExecutionError, NxosError, NxosRequestNotSupported
...
class NxosTestCase(TestCase):
    def test_show_nxapi_response_no_dict(self):
        ...
        with patch.object(nxos_utils.NxapiClient, "__init__", lambda a: None):
            result = nxos_utils.NxapiClient().parse_response(
                RESPONSE_NO_DICT, command_list
            )
    ...
    def test_show_nxapi_response_error_400(self):
        ...
        with patch.object(nxos_utils.NxapiClient, "__init__", lambda a: None):
            with self.assertRaises(CommandExecutionError):
                nxos_utils.NxapiClient().parse_response(RESPONSE_400, command_list)
    ...
    def test_show_nxapi_response_error_413(self):
        ...
        with patch.object(nxos_utils.NxapiClient, "__init__", lambda a: None):
            with self.assertRaises(NxosRequestNotSupported):
                nxos_utils.NxapiClient().parse_response(RESPONSE_413, command_list)
    ...
    def test_show_nxapi_response_error_501(self):
        ...
        with patch.object(nxos_utils.NxapiClient, "__init__", lambda a: None):
            with self.assertRaises(NxosError):
                nxos_utils.NxapiClient().parse_response(RESPONSE_501, command_list)
    ...
    def test_show_nxapi_response_error(self):
        ...
        with patch.object(nxos_utils.NxapiClient, "__init__", lambda a: None):
            with self.assertRaises(NxosError):
                nxos_utils.NxapiClient().parse_response(RESPONSE_ERROR, command_list)
