        ...
        with patch.object(group, '_changes', mock):
            ...
            with patch.dict(group.__opts__, {"test": False}):
                ...
                with patch.dict(group.__salt__, {'group.getent': mock}):
                    ...
                    assert group.present("salt", 1) == ret
