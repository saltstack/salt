...
class IptablesTestCase(TestCase, LoaderModuleMockMixin):
                ...
                with patch.dict(iptables.__salt__, {'iptables.flush': mock}):
                    ...
                    with patch.dict(iptables.__salt__,
                        ...
                        ret.update({'changes': {'locale': 'salt'},
                                    ...
                                    'result': True})
                        assert iptables.chain_absent("salt") == \
                                             ret
    ...
    def test_mod_aggregate(self):
        ...
        '''
        assert iptables.mod_aggregate({'fun': 'salt'}, [], []) == \
                             {'fun': 'salt'}
