...
class CloudTestCase(TestCase):
    ...
    def test_volume_attached(self):
        ...
        mock = MagicMock(return_value=False)
        mock_dict = MagicMock(side_effect=[{name: {'attachments': True}}, {},
        ...
        with patch.dict(cloud.__salt__, {'cloud.volume_list': mock_dict,
            ...
            comt = ('Volume mycloud is already attached: True')
            ret.update({'comment': comt, 'result': True})
    ...
    def test_volume_detached(self):
        ...
        mock = MagicMock(return_value=False)
        mock_dict = MagicMock(side_effect=[{name: {'attachments': False}}, {},
        ...
        with patch.dict(cloud.__salt__, {'cloud.volume_list': mock_dict,
            ...
            comt = ('Volume mycloud is not currently attached to anything.')
            ret.update({'comment': comt, 'result': True})
