...
from unit.modules.test_boto_iot import BotoIoTTestCaseMixin
...
class BotoIoTStateTestCaseBase(TestCase):
    ...
    def setUp(self):
        ...
        self.funcs = funcs = salt.loader.minion_mods(opts, context=context, utils=utils, whitelist=['boto_iot'])
        self.salt_states = salt.loader.states(opts=opts, functions=funcs, utils=utils, whitelist=['boto_iot'],
