...
class BotoCloudTrailStateTestCaseBase(TestCase, LoaderModuleMockMixin):
    ...
    def setUp(self):
        ...
        self.funcs = funcs = salt.loader.minion_mods(opts, context=context, utils=utils, whitelist=['boto_cloudtrail'])
        self.salt_states = salt.loader.states(opts=opts, functions=funcs, utils=utils, whitelist=['boto_cloudtrail'],
