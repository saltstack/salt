...
class WinIisTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_deployed_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {"win_iis.list_sites": list_sites, "win_iis.create_site": create_site},
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                create_site.assert_called_once_with(
                    "test0", "C:\\User\\Person\\Folder", "", "", "*", 80, "http"
                )

                self.assertDictEqual(
                    ret,
                    {
                        "changes": {"new": "test0", "old": None},
    ...
    def test_remove_site_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {"win_iis.list_sites": list_sites, "win_iis.remove_site": remove_site},
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
    ...
    def test_create_binding_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {
                "win_iis.list_bindings": list_bindings,
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                create_binding.assert_called_once_with("site0", "", "*", 80, "http", 0)

                self.assertDictEqual(
                    ret,
                    {
                        "changes": {"new": "*:80:", "old": None},
    ...
    def test_remove_binding_pass(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                list_bindings.assert_called_once_with("site0")
                remove_binding.assert_called_once_with("site0", "", "*", 80)

                self.assertDictEqual(
                    ret,
                    {
                        "changes": {"new": None, "old": "*:80:"},
    ...
    def test_create_cert_binding_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {
                "win_iis.list_cert_bindings": list_cert_bindings,
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                create_cert_binding.assert_called_once_with(
                    "test0", "site0", "", "*", 443, 0
                )
    ...
    def test_create_cert_binding_no_action_need_it(self):
        list_cert_bindings = MagicMock(
            return_value={"*:443:": {"certificatehash": "test0"}}
        )
        create_cert_binding = MagicMock(return_value=True)
    ...
    def test_create_cert_binding_no_action_need_it_2(self):
        list_cert_bindings = MagicMock(
            return_value={"*:443:": {"certificatehash": "test404"}}
        )
        create_cert_binding = MagicMock(return_value=True)
    ...
    def test_remove_cert_binding_pass(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                list_cert_bindings.assert_called_once_with("site0")
                remove_cert_binding.assert_called_once_with(
                    "test0", "site0", "", "*", 443
                )
    ...
    def test_remove_cert_binding_pass_2(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                self.assertDictEqual(
                    ret, {"changes": {}, "comment": "", "name": "test0", "result": None}
                )
    ...
    def test_remove_cert_binding_no_action_need_it(self):
        list_cert_bindings = MagicMock(
            return_value={"*:444:": {"certificatehash": "test0"}}
        )
        remove_cert_binding = MagicMock(return_value=True)
    ...
    def test_create_apppool_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {
                "win_iis.list_apppools": list_apppools,
    ...
    def test_container_setting_no_settings(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {
                "win_iis.get_container_setting": get_container_setting,
    ...
    def test_container_setting_pass(self):
        get_container_setting = MagicMock(
            side_effect=[
                {
                    "managedPipelineMode": "Integrated_old",
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                self.assertEqual(
                    get_container_setting.mock_calls[0],
                    call(
                        container="AppPools",
                        name="test0",
                        settings={
                ...
                self.assertEqual(
                    get_container_setting.mock_calls[1],
                    call(
                        container="AppPools",
                        name="test0",
                        settings={
                ...
                set_container_setting.assert_called_once_with(
                    container="AppPools",
                    name="test0",
                    settings={
                        "managedPipelineMode": "Integrated",
                    ...
                    ret,
                    {
                        "changes": {
                            ...
                            "failures": {
                                ...
                                "processModel.identityType": {"new": "ERROR", "old": 4},
                                "processModel.maxProcesses": {"new": "ERROR", "old": 1},
                                "processModel.password": {
                                    "new": "ERROR",
                                    "old": "TestPassword_old",
                                },
    ...
    def test_container_setting_test_pass(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": True}):
                ...
                get_container_setting.assert_called_once_with(
                    container="AppPools",
                    name="test0",
                    settings={
                        "managedPipelineMode",
    ...
    def test_create_app_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {"win_iis.list_apps": list_apps, "win_iis.create_app": create_app},
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
                ret = win_iis.create_app(
                    "test0", "site0", "C:\\User\\Person\\Folder", "pool"
                )
    ...
    def test_remove_app_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {"win_iis.list_apps": list_apps, "win_iis.remove_app": remove_app},
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
    ...
    def test_create_vdir_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {"win_iis.list_vdirs": list_vdirs, "win_iis.create_vdir": create_vdir},
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
                ret = win_iis.create_vdir(
                    "test0", "site0", "C:\\User\\Person\\Folder", "\\"
                )

                list_vdirs.assert_called_once_with("site0", "\\")
                create_vdir.assert_called_once_with(
                    "test0", "site0", "C:\\User\\Person\\Folder", "\\"
                )
    ...
    def test_remove_vdir_pass(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {"win_iis.list_vdirs": list_vdirs, "win_iis.remove_vdir": remove_vdir},
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
                ret = win_iis.remove_vdir("test0", "site0", "\\")

                list_vdirs.assert_called_once_with("site0", "\\")
                remove_vdir.assert_called_once_with("test0", "site0", "\\")
    ...
    def test_set_app_no_settings(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {
                "win_iis.get_webapp_settings": get_webapp_settings,
    ...
    def test_set_app_pass(self):
        get_webapp_settings = MagicMock(
            side_effect=[
                {
                    "userName": "domain\\user_old",
                    "password": "pass_old",
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                self.assertEqual(
                    get_webapp_settings.mock_calls[0],
                    call(
                        name="test0",
                        site="site0",
                        settings={
                ...
                self.assertEqual(
                    get_webapp_settings.mock_calls[1],
                    call(
                        name="test0",
                        site="site0",
                        settings={
                ...
                set_webapp_settings.assert_called_with(
                    name="test0",
                    site="site0",
                    settings={
                        "userName": "domain\\user",
                ...
                self.assertDictEqual(
                    ret,
                    {
                        "changes": {
                            ...
                            "password": {"new": "pass", "old": "pass_old"},
                            "physicalPath": {
                                "new": "C:\\User\\Person\\Folder",
                    ...
                    ret,
                    {
                        "changes": {
                            ...
                            "failures": {
                                ...
                                "password": {"new": "ERROR", "old": "pass_old"},
                                "physicalPath": {
                                    "new": "ERROR",
                                    "old": "C:\\User\\Person\\Folder_old",
                                },
                                "userName": {"new": "ERROR", "old": "domain\\user_old"},
                            },
                        },
                        "comment": "Some settings failed to change.",
                        "name": "test0",
    ...
    def test_set_app_test_pass(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": True}):
                ...
                get_webapp_settings.assert_called_with(
                    name="test0",
                    site="site0",
                    settings={
                        "userName",
    ...
    def test_webconfiguration_no_settings(self):
        ...
        with patch.dict(
            win_iis.__salt__,
            {
                "win_iis.get_webconfiguration_settings": get_webconfiguration_settings,
                "win_iis.set_webconfiguration_settings": set_webconfiguration_settings,
            },
        ):
            with patch.dict(win_iis.__opts__, {"test": False}):
                ret = win_iis.webconfiguration_settings(
                    "test0", "C:\\User\\Person\\Folder", {}
                )
    ...
    def test_webconfiguration_settings_pass(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": False}):
                ...
                set_webconfiguration_settings.assert_called_once_with(
                    location="C:\\User\\Person\\Folder",
                    name="test0",
                    settings=[
                        {
                ...
                self.assertDictEqual(
                    ...
                    {
                        "changes": {
                            "system.webServer/security/authentication/basicAuthentication.enabled": {
                                "new": True,
                                "old": False,
                            }
                        },
    ...
    def test_webconfiguration_settings_test_pass(self):
        ...
        with patch.dict(
            ...
            with patch.dict(win_iis.__opts__, {"test": True}):
                ...
                get_webconfiguration_settings.assert_called_with(
                    location="C:\\User\\Person\\Folder",
                    name="test0",
                    settings=[
                        {
