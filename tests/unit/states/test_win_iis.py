...
class WinIisTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_webconfiguration_no_settings(self):
        ...
        with patch.dict(win_iis.__salt__, {'win_iis.get_webconfiguration_settings': get_webconfiguration_settings,
            ...
            with patch.dict(win_iis.__opts__, {'test': False}):
                ret = win_iis.webconfiguration_settings('test0', 'C:\\User\\Person\\Folder', {})
    ...
    def test_webconfiguration_settings_pass(self):
        ...
        with patch.dict(win_iis.__salt__, {'win_iis.get_webconfiguration_settings': get_webconfiguration_settings,
                                           'win_iis.set_webconfiguration_settings': set_webconfiguration_settings}):
            with patch.dict(win_iis.__opts__, {'test': False}):
                ret = win_iis.webconfiguration_settings('test0',
                                                        'C:\\User\\Person\\Folder',
                                                        {'system.webServer/security/authentication/basicAuthentication': {'enabled': True}})

                self.assertEqual(get_webconfiguration_settings.call_count, 2)
                self.assertEqual(get_webconfiguration_settings.mock_calls[0], call(location='C:\\User\\Person\\Folder',
                                                                                   name='test0',
                                                                                   settings=[{'filter': 'system.webServer/security/authentication/basicAuthentication',
                                                                                              'name': 'enabled',
                                                                                              'value': True}]))
                self.assertEqual(get_webconfiguration_settings.mock_calls[1], call(location='C:\\User\\Person\\Folder',
                                                                                   name='test0',
                                                                                   settings=[{'filter': 'system.webServer/security/authentication/basicAuthentication',
                                                                                              'name': 'enabled',
                                                                                              'value': True}]))

                set_webconfiguration_settings.assert_called_once_with(location='C:\\User\\Person\\Folder',
                                                                      name='test0',
                                                                      settings=[{'filter': 'system.webServer/security/authentication/basicAuthentication',
                                                                                 'name': 'enabled',
                                                                                 'value': True}])
    ...
    def test_webconfiguration_settings_fail(self):
        get_webconfiguration_settings = MagicMock(side_effect=[[{'filter': 'system.webServer/security/authentication/basicAuthentication', 'name': 'enabled', 'value': False}],
                                                               [{'filter': 'system.webServer/security/authentication/basicAuthentication', 'name': 'enabled', 'value': "ERROR"}]])
        set_webconfiguration_settings = MagicMock(return_value=None)
        with patch.dict(win_iis.__salt__, {'win_iis.get_webconfiguration_settings': get_webconfiguration_settings,
                                           'win_iis.set_webconfiguration_settings': set_webconfiguration_settings}):
            with patch.dict(win_iis.__opts__, {'test': False}):
    ...
    def test_webconfiguration_settings_test_pass(self):
        ...
        with patch.dict(win_iis.__salt__, {'win_iis.get_webconfiguration_settings': get_webconfiguration_settings,
            ...
            with patch.dict(win_iis.__opts__, {'test': True}):
                ...
                get_webconfiguration_settings.assert_called_with(location='C:\\User\\Person\\Folder',
                                                                 name='test0',
                                                                 settings=[{'filter': 'system.webServer/security/authentication/basicAuthentication',
                                                                            'name': 'enabled', 'value': True}])
                set_webconfiguration_settings.assert_not_called()
