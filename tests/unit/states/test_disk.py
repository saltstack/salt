...
class DiskTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def setup_loader_modules(self):
        ...
        return {disk: {'__salt__': {'disk.usage': MagicMock(return_value=self.mock_data), 'status.diskusage': MagicMock(return_value=self.mock_data_path)}}}
    ...
    def test_status(self):
        ...
        mock = MagicMock(side_effect=[[], {mock_fs: data_1}, {mock_fs: data_2}, {mock_fs: data_3}])
