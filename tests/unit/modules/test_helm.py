...
class HelmTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test__prepare_cmd_kvflags(self):
        ...
        #
        self.assertEqual(True, result_tuple == tuple_valide_1 or result_tuple == tuple_valide_2)
    ...
    def test__exec_dict_return_valide_no_json(self):
        _exec_cmd_return = {'retcode': 0, 'stdout': "{\"test\": true}"}
        with patch('salt.modules.helm._exec_cmd', MagicMock(return_value=_exec_cmd_return)):
            self.assertEqual("{\"test\": true}", helm._exec_dict_return(kvflags={'output': 'table'}))
    ...
    def test_completion(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['completion', 'bash'], flags=None, kvflags=None)],
    ...
    def test_create(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['create', 'name'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_dependency_build(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['dependency', 'build', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_dependency_list(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['dependency', 'list', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_dependency_update(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['dependency', 'update', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_env(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['env'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_get_all(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['get', 'all', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_get_hooks(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['get', 'hooks', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_get_manifest(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['get', 'manifest', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_get_notes(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['get', 'notes', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_get_values(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['get', 'values', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_help_(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['help', 'command'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_history(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['history', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_install(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['install', 'release', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_lint(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['lint', 'path'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_list_(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['list'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_package(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['package', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_plugin_install(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['plugin', 'install', 'path'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_plugin_list(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['plugin', 'list'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_plugin_uninstall(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['plugin', 'uninstall', 'plugin'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_plugin_update(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['plugin', 'update', 'plugin'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_pull(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['pull', 'pkg'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_repo_add(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['repo', 'add', 'name', 'url'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_repo_index(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['repo', 'index', 'directory'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_repo_list(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['repo', 'list'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_repo_remove(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['repo', 'remove', 'name'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_repo_update(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['repo', 'update'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_repo_manage_present_failed(self):
        ...
        with patch('salt.modules.helm.repo_list', MagicMock(return_value=None)):
            with patch('salt.modules.helm.repo_add', MagicMock(return_value='failed')):
                self.assertEqual(helm.repo_manage(present=[{'name': 'myname', 'url': 'myurl'}]),
                                 result_wanted)
    ...
    def test_repo_manage_present_already_present(self):
        result_wanted = {"present": [{'name': 'myname', 'url': 'myurl'}],
                         "added": [],
                         "absent": [],
                         "removed": [],
                         "failed": []}
    ...
    def test_repo_manage_prune(self):
        ...
        with patch('salt.modules.helm.repo_list', MagicMock(return_value=[{'name': 'myname', 'url': 'myurl'}])):
            with patch('salt.modules.helm.repo_remove', MagicMock(return_value=True)):
                self.assertEqual(helm.repo_manage(prune=True),
                                 result_wanted)
    ...
    def test_rollback(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['rollback', 'release', 'revision'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_search_hub(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['search', 'hub', 'keyword'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_search_repo(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['search', 'repo', 'keyword'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_show_all(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['show', 'all', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_show_chart(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['show', 'chart', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_show_readme(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['show', 'readme', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_show_values(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['show', 'values', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_status(self):
        ...
        with patch('salt.modules.helm._exec_dict_return', magic_mock):
            ...
            self.assertEqual([call(commands=['status', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_template(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['template', 'name', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_test(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['test', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_uninstall(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['uninstall', 'release'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_upgrade(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['upgrade', 'release', 'chart'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_verify(self):
        ...
        with patch('salt.modules.helm._exec_true_return', magic_mock):
            ...
            self.assertEqual([call(commands=['verify', 'path'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
    ...
    def test_version(self):
        ...
        with patch('salt.modules.helm._exec_string_return', magic_mock):
            ...
            self.assertEqual([call(commands=['version'], flags=None, kvflags=None)],
                             magic_mock.mock_calls)
