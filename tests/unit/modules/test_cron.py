...
class CronTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_get_entry(self):
        ...
        get_entry_3 = {'comment': 'cron_3',
                       ...
                       'minute': 'but',
                       'month': 'a'}
        with patch('salt.modules.cron.list_tab', new=MagicMock(return_value=list_tab_output)):
            ...
            get_entry_output = cron.get_entry('root', identifier='cron_3', cmd='my_cmd_2')
            self.assertDictEqual(get_entry_output, get_entry_3)
