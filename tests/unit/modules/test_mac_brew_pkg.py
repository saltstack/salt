    ...
    def test_info_installed(self):
        ...
        mock_cmd_all = MagicMock(
            return_value={
                ...
                "stderr": "",
                "stdout": """\
                {"formulae":[{"name":"salt","full_name":"cdalvaro/tap/salt","tap":"cdalvaro/tap","aliases":[]},{"name":"vim","full_name":"vim","tap":"homebrew/core","aliases":[]}],"casks":[{"token":"visual-studio-code","full_token":"visual-studio-code","tap":"homebrew/cask","name":["MicrosoftVisualStudioCode","VSCode"]}]}
                """,
            }
        )
        _expected = {
