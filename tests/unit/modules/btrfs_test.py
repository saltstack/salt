...
class BtrfsTestCase(TestCase):
    ...
    @patch('salt.modules.fsutils._verify_run', MagicMock(return_value=True))
    def test_info(self):
        '''
    ...
    @patch('salt.modules.fsutils._blkid_output',
    ...
    @patch('salt.modules.fsutils._is_device', MagicMock(return_value=True))
    ...
    def test_mkfs(self):
        ...
        with patch.dict(btrfs.__salt__, {'cmd.run_all': mock,
            ...
            self.assertEqual(btrfs.mkfs('/dev/sda1'), {'log': 'Salt'})
    ...
    def test_mkfs_mount_error(self):
        ...
        '''
        mock = MagicMock(return_value={'/dev/sda1': True})
        with patch.object(salt.modules.fsutils, '_get_mounts', mock):
    ...
    def test_resize(self):
        ...
        with patch.dict(btrfs.__salt__, {'cmd.run_all': mock,
            ...
            mock = MagicMock(return_value={'/dev/sda1': True})
            with patch.object(salt.modules.fsutils, '_get_mounts', mock):
                self.assertEqual(btrfs.resize('/dev/sda1', 'max'),
                                 {'log': 'Salt'})
    ...
    def test_add(self):
        ...
        '''
        self.assertEqual(btrfs.add('/mountpoint', '/dev/sda1', '/dev/sda2'),
                         {})
    ...
    def test_delete(self):
        ...
        '''
        self.assertEqual(btrfs.delete('/mountpoint', '/dev/sda1',
                                      '/dev/sda2'), {})
    ...
    def test_properties(self):
        ...
        mock = MagicMock(return_value={'retcode': 1,
                                       ...
                                       'stdout': 'Salt'})
        with patch.dict(btrfs.__salt__, {'cmd.run_all': mock}):
            self.assertEqual(btrfs.properties('/dev/sda1', 'subvol'), {})
