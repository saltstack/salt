...
class IpsetTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_new_set(self):
        ...
        '''
        assert ipset.new_set() == 'Error: Set needs to be specified'
        ...
        assert ipset.new_set('s', 'bitmap:ip') == \
