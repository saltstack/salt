...
class WinServiceTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_service_dependencies(self):
        ...
        self.assertListEqual(['Sandy'], spongebob.customers(with_indirect=False))
        self.assertListEqual(['Sandy', 'Patrick'], spongebob.customers(with_indirect=True))
        self.assertListEqual(['Garry', 'Spongebob', 'Sandy', 'Patrick'], spongebob.start_order(with_deps=True, with_customers=True))
        self.assertListEqual(['Patrick', 'Sandy', 'Spongebob', 'Garry'], spongebob.stop_order(with_deps=True, with_customers=True))
        ...
        self.assertListEqual(['Garry', 'Spongebob', 'Sandy', 'Patrick'], spongebob.start_order(with_deps=True, with_customers=True))
        self.assertListEqual(['Patrick', 'Sandy', 'Spongebob', 'Garry'], spongebob.stop_order(with_deps=True, with_customers=True))
        self.assertListEqual(['Spongebob'], spongebob.start_order(with_deps=False, with_customers=False))
        self.assertListEqual(['Spongebob'], spongebob.stop_order(with_deps=False, with_customers=False))
        ...
        self.assertListEqual(['Patrick', 'Spongebob'], garry.customers(with_indirect=False))
        self.assertListEqual(['Spongebob', 'Sandy', 'Patrick'], garry.customers(with_indirect=True))
        self.assertListEqual(['Garry', 'Spongebob', 'Sandy', 'Patrick'], spongebob.start_order(with_deps=True, with_customers=True))
        self.assertListEqual(['Patrick', 'Sandy', 'Spongebob', 'Garry'], spongebob.stop_order(with_deps=True, with_customers=True))
        ...
        self.assertListEqual(['Heffer'], rocko.customers(with_indirect=False))
        self.assertListEqual(['Heffer'], rocko.customers(with_indirect=True))
