 ...
 <message type="error">Another zypper internal error</message>
    ...
    def test_refresh_zypper_flags(self):
        ...
        with patch(
            ...
            assert not zypper.__zypper__.inst_avc
            assert not zypper.__zypper__.dup_avc
        with patch(
            ...
            zypper.__zypper__.refresh_zypper_flags()
            assert not zypper.__zypper__.inst_avc
            assert zypper.__zypper__.dup_avc
        with patch(
            ...
            zypper.__zypper__.refresh_zypper_flags()
            assert zypper.__zypper__.inst_avc
            assert zypper.__zypper__.dup_avc
