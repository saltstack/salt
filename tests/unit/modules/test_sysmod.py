...
class SysmodTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_doc(self):
        ...
        '''
        assert sysmod.doc() == self._docstrings

        assert sysmod.doc('sys.doc') == {'sys.doc': 'docstring for sys.doc'}
    ...
    def test_state_doc(self):
        ...
        '''
        assert sysmod.state_doc() == self._statedocstrings

        assert sysmod.state_doc('sys.doc') == {'sys': 'docstring for sys', 'sys.doc': 'docstring for sys.doc'}
    ...
    def test_runner_doc(self):
        ...
        '''
        assert sysmod.runner_doc() == self._docstrings

        assert sysmod.runner_doc('sys.doc') == {'sys.doc': 'docstring for sys.doc'}
    ...
    def test_returner_doc(self):
        ...
        '''
        assert sysmod.returner_doc() == self._docstrings

        assert sysmod.returner_doc('sys.doc') == {'sys.doc': 'docstring for sys.doc'}
    ...
    def test_renderer_doc(self):
        ...
        '''
        assert sysmod.renderer_doc() == self._docstrings

        assert sysmod.renderer_doc('sys.doc') == {'sys.doc': 'docstring for sys.doc'}
    ...
    def test_list_functions(self):
        ...
        '''
        assert sysmod.list_functions() == self._functions

        assert sysmod.list_functions('nonexist') == []

        # list all functions in/given a specific module
        assert sysmod.list_functions('sys') == ['sys.doc', 'sys.list_functions', 'sys.list_modules']

        # globs can be used for both module names and function names:
        assert sysmod.list_functions('sys*') == ['sys.doc', 'sys.list_functions', 'sys.list_modules', 'sysctl.get', 'sysctl.show', 'system.halt', 'system.reboot']
        assert sysmod.list_functions('sys.list*') == ['sys.list_functions', 'sys.list_modules']

        # "list", or check for a specific function:
        assert sysmod.list_functions('sys.list') == []
        assert sysmod.list_functions('exist.exist') == ['exist.exist']
    ...
    def test_list_modules(self):
        ...
        '''
        assert sysmod.list_modules() == self._modules

        assert sysmod.list_modules('nonexist') == []

        assert sysmod.list_modules('user') == ['user']

        assert sysmod.list_modules('s*') == ['sys', 'sysctl', 'system']
    ...
    def test_returner_argspec(self):
        ...
        '''
        assert sysmod.returner_argspec() == {}
    ...
    def test_list_state_functions(self):
        ...
        '''
        assert sysmod.list_state_functions() == self._functions

        assert sysmod.list_state_functions('nonexist') == []

        # list all functions in/given a specific module
        assert sysmod.list_state_functions('sys') == ['sys.doc', 'sys.list_functions', 'sys.list_modules']

        # globs can be used for both module names and function names:
        assert sysmod.list_state_functions('sys*') == ['sys.doc', 'sys.list_functions', 'sys.list_modules', 'sysctl.get', 'sysctl.show', 'system.halt', 'system.reboot']
        assert sysmod.list_state_functions('sys.list*') == ['sys.list_functions', 'sys.list_modules']

        # "list", or check for a specific function:
        assert sysmod.list_state_functions('sys.list') == []
        assert sysmod.list_state_functions('exist.exist') == ['exist.exist']
    ...
    def test_list_state_modules(self):
        ...
        Test if it lists the modules loaded on the minion.
        '''
        assert sysmod.list_state_modules() == self._modules

        assert sysmod.list_state_modules('nonexist') == []

        assert sysmod.list_state_modules('user') == ['user']

        assert sysmod.list_state_modules('s*') == ['sys', 'sysctl', 'system']
    ...
    def test_list_runners(self):
        ...
        '''
        assert sysmod.list_runners() == self._modules

        assert sysmod.list_runners('nonexist') == []

        assert sysmod.list_runners('user') == ['user']

        assert sysmod.list_runners('s*') == ['sys', 'sysctl', 'system']
    ...
    def test_list_runner_functions(self):
        ...
        '''
        assert sysmod.list_runner_functions() == self._functions

        assert sysmod.list_runner_functions('nonexist') == []

        # list all functions in/given a specific module
        assert sysmod.list_runner_functions('sys') == ['sys.doc', 'sys.list_functions', 'sys.list_modules']

        # globs can be used for both module names and function names:
        assert sysmod.list_runner_functions('sys*') == ['sys.doc', 'sys.list_functions', 'sys.list_modules', 'sysctl.get', 'sysctl.show', 'system.halt', 'system.reboot']
        assert sysmod.list_runner_functions('sys.list*') == ['sys.list_functions', 'sys.list_modules']

        # "list", or check for a specific function:
        assert sysmod.list_runner_functions('sys.list') == []
        assert sysmod.list_runner_functions('exist.exist') == ['exist.exist']
    ...
    def test_list_returners(self):
        ...
        '''
        assert sysmod.list_returners() == self._modules

        assert sysmod.list_returners('nonexist') == []

        assert sysmod.list_returners('user') == ['user']

        assert sysmod.list_returners('s*') == ['sys', 'sysctl', 'system']
    ...
    def test_list_returner_functions(self):
        ...
        '''
        assert sysmod.list_returner_functions() == self._functions

        assert sysmod.list_returner_functions('nonexist') == []

        # list all functions in/given a specific module
        assert sysmod.list_returner_functions('sys') == ['sys.doc', 'sys.list_functions', 'sys.list_modules']

        # globs can be used for both module names and function names:
        assert sysmod.list_returner_functions('sys*') == ['sys.doc', 'sys.list_functions', 'sys.list_modules', 'sysctl.get', 'sysctl.show', 'system.halt', 'system.reboot']
        assert sysmod.list_returner_functions('sys.list*') == ['sys.list_functions', 'sys.list_modules']

        # "list", or check for a specific function:
        assert sysmod.list_returner_functions('sys.list') == []
        assert sysmod.list_returner_functions('exist.exist') == ['exist.exist']
    ...
    def test_list_renderers(self):
        ...
        '''
        assert sysmod.list_renderers() == self._functions

        assert sysmod.list_renderers('nonexist') == []

        assert sysmod.list_renderers('user.info') == ['user.info']

        assert sysmod.list_renderers('syst*') == ['system.halt', 'system.reboot']
