...
class RandomOrgTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_getusage(self):
        ...
        ret = {'message': 'No Random.org api key or api version found.',
               'res': False}
        assert random_org.getUsage() == ret

        assert random_org.getUsage(api_key='peW',
                                                 api_version='1') == \
    ...
    def test_generateintegers(self):
        ...
        ret1 = {'message': 'No Random.org api key or api version found.',
                'res': False}
        assert random_org.generateIntegers() == ret1

        ret2 = {'message': 'Rquired argument, number is missing.', 'res': False}
        assert random_org.generateIntegers(api_key='peW',
                                                         api_version='1') == ret2
    ...
    def test_generatestrings(self):
        ...
        ret1 = {'message': 'No Random.org api key or api version found.',
                'res': False}
        assert random_org.generateStrings() == ret1

        ret2 = {'message': 'Required argument, number is missing.',
                'res': False}
        assert random_org.generateStrings(api_key='peW',
                                                        api_version='1') == ret2
    ...
    def test_generateuuids(self):
        ...
        ret1 = {'message': 'No Random.org api key or api version found.',
                'res': False}
        assert random_org.generateUUIDs() == ret1

        ret2 = {'message': 'Required argument, number is missing.',
                'res': False}
        assert random_org.generateUUIDs(api_key='peW',
                                                      api_version='1') == ret2
    ...
    def test_generatedecimalfractions(self):
        ...
        ret1 = {'message': 'No Random.org api key or api version found.',
                'res': False}
        assert random_org.generateDecimalFractions() == ret1

        ret2 = {'message': 'Required argument, number is missing.',
                'res': False}
        assert random_org.generateDecimalFractions(api_key='peW', api_version='1') == ret2

        ret3 = {'message': ('Number of decimal fractions must be'
                            ' between 1 and 10000'), 'res': False}
        assert random_org.generateDecimalFractions(api_key='peW', api_version='1', number='5',
    ...
    def test_generategaussians(self):
        ...
        ret1 = {'message': 'No Random.org api key or api version found.',
                'res': False}
        assert random_org.generateGaussians() == ret1

        ret2 = {'message': 'Required argument, number is missing.',
                'res': False}
        assert random_org.generateGaussians(api_key='peW', api_version='1') == ret2

        ret3 = {'message': ('Number of decimal fractions must be'
                            ' between 1 and 10000'), 'res': False}
        assert random_org.generateGaussians(api_key='peW', api_version='1',
        ...
        assert random_org.generateGaussians(api_key='peW', api_version='1', number=5,
        ...
        ret7 = {'message': "Parameter 'apiKey' is malformed", 'res': False}
        assert random_org.generateGaussians(api_key='peW',
                                            api_version='1',
                                            number=5, mean=0.0,
                                            standardDeviation=1.0,
                                            significantDigits=8) == ret7
    ...
    def test_generateblobs(self):
        ...
        ret1 = {'message': 'No Random.org api key or api version found.',
                'res': False}
        assert random_org.generateBlobs() == ret1

        ret2 = {'message': 'Required argument, number is missing.',
                'res': False}
        assert random_org.generateBlobs(api_key='peW', api_version='1') == ret2

        ret3 = {'message': 'Number of blobs must be between 1 and 100',
                'res': False}
        assert random_org.generateBlobs(api_key='peW', api_version='1',
                                        number='5', size='1') == ret3

        ret4 = {'message': 'Number of blobs must be between 1 and 100',
                'res': False}
        assert random_org.generateBlobs(api_key='peW', api_version='1', number=5, size=1) == ret4

        ret5 = {'message': 'Format must be either base64 or hex.', 'res': False}
        assert random_org.generateBlobs(api_key='peW', api_version='1', number=5, size=8, format='oct') == ret5

        ret6 = {'message': "Parameter 'apiKey' is malformed", 'res': False}
        assert random_org.generateBlobs(api_key='peW',
                                        api_version='1',
                                        number=5, size=8,
                                        format='hex') == ret6
