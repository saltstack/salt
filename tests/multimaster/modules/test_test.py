...
class TestModuleTest(MultimasterModuleCase, AdaptedConfigurationTestCaseMixin):
    ...
    def test_ping(self):
        ...
        test.ping
        '''
        assert self.run_function_all_masters('test.ping') == [True] * 2

    def test_echo(self):
        '''
        test.echo
        '''
        assert self.run_function_all_masters('test.echo', ['text']) == ['text'] * 2

    def test_version(self):
        '''
        test.version
        '''
        assert self.run_function_all_masters('test.version') == \
    ...
    def test_conf_test(self):
        ...
        test.conf_test
        '''
        assert self.run_function_all_masters('test.conf_test') == ['baz'] * 2
    ...
    def test_get_opts(self):
        ...
        assert ret[0]['cachedir'] == \
            opts['cachedir']
        assert ret[1]['cachedir'] == \
            opts['cachedir']
    ...
    def test_cross_test(self):
        ...
        test.cross_test
        '''
        assert self.run_function_all_masters(
                    'test.cross_test',
                    ['test.ping']
                    )
    ...
    def test_outputter(self):
        ...
        test.outputter
        '''
        assert self.run_function_all_masters('test.outputter', ['text']) == ['text'] * 2
