...
class SaltTestsuiteParser(SaltCoverageTestingParser):
    ...
    def start_daemons_only(self):
        ...
        with TestDaemon(self):
            ...
            print('transport: {0}'.format(syndic_master_conf['transport']))
            print('\n')
            ...
            print('tcp pub port: {0}'.format(syndic_conf['tcp_pub_port']))
            print('tcp pull port: {0}'.format(syndic_conf['tcp_pull_port']))
            print('\n')
            ...
            print('transport: {0}'.format(master_conf['transport']))
            print('\n')
            ...
            print('transport: {0}'.format(minion_conf['transport']))
            ...
            print('transport: {0}'.format(sub_minion_conf['transport']))
