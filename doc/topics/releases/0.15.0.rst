...
smaller features and a few larger ones. The new Salt Mine system fills in a
needed component of tracking data from systems. IPV6 support has been added,
copy files from the minions up to the master, better template debugging, more
event firing, major syndic and peer system updates, minion key revocation,
functions in overstate, updates to pillar error reporting, Cached state data,
monitoring states
