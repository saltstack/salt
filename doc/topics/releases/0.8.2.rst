...
and the deploy functionlity has been embiggened! Read on to see the cromulent
new features.
...
automatically install the required libriaries and build ZeroMQ, and then use
...
started using the OpenStack module, because pull reqs have already been
