...
enhancements in the :py:mod:`rest_cherrypy <saltapi.netapi.rest_cherrypy.app>`
netapi module.
...
<saltapi.netapi.rest_cherrypy.app.Webhook>` that allows salt-api to serve as a
...
The :py:meth:`~saltapi.APIClient.local_batch` client exposes Salt's batch mode
...
<saltapi.netapi.rest_cherrypy.app.Stats>` has been added to expose metrics on
...
<saltapi.netapi.rest_cherrypy.app.Jobs>` has been augmented with more
...
<saltapi.netapi.rest_cherrypy.app.Event>` as SSE tags which allows JavaScript
