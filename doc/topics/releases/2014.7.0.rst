...
.. important::
    ...
    The Fedora/RHEL/CentOS packages have been modified for this release. The
    following components of Salt have been broken out of the salt-master
    package and placed into their own packages:

    * salt-syndic
    * salt-cloud
    * salt-ssh

    When the salt-master package is upgraded, these components will be removed,
    and they will need to be manually installed.
