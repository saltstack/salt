...
The Salt Minion does not clean up files in ``/tmp`` when rendering templates. This results in
potentially results in either running out of disk space or running out of inodes. Please see
`Issue #37541`_ for more information. This bug was fixed with `Pull Request #37540`_, which will
be available in the ``2016.3.5`` release of Salt.
