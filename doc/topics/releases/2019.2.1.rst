...
This release has a known issue in the master daemon when the ``event_return``
option is set in the master's config.  If you are using the ``event_return``
config option it is recommended that you skip this release, 2019.2.2 will
address this issue. This only affects PY3 versions of Salt.
