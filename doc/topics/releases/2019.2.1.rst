...
* **ISSUE** `#54256`_: (`sleminov-tc`_) Empty salt api token file breaks maintenance process. (refs: `#54388`_, `#54376`_, `#54324`_, `#54325`_)

* **ISSUE** `#37945`_: (`gstachowiak`_) Missing exception handling in salt.master.Maintenance. Process never completes. (refs: `#54388`_, `#54376`_, `#54324`_, `#54325`_)
...
* **PR** `#54388`_: (`dwoz`_) 54256 re fix empty api token 2019.2.1
  ...
  * **PR** `#54324`_: (`waynew`_) Delete bad API token files (refs: `#54388`_, `#54325`_)
...
* **ISSUE** `#49680`_: (`doesitblend`_) Beacon events handled differently than event.send (refs: `#54239`_, `#53344`_)

* **ISSUE** `#49663`_: (`doesitblend`_) Beacon only fires to single random master in HA mode (refs: `#54239`_, `#53344`_)
...
* **ISSUE** `#53411`_: (`cro`_) Events can grow stale when event_listen_queue is set. (refs: `#53412`_, `#53587`_)
...
* **ISSUE** `#52926`_: (`waynew`_) integration.states.test_beacon.BeaconStateTestCase.test_present_absent - Beacon "diskusage" is not available (refs: `#53466`_, `#53493`_)

* **ISSUE** `#52245`_: (`twangboy`_) integration.states.test_beacon.BeaconStateTestCase.test_present_absent (refs: `#53466`_, `#53493`_)
...
* **PR** `#52615`_: (`twangboy`_)  Bring 51661 into 2019.2.1
  ...
  * **PR** `#50768`_: (`sathieu`_) git_pillar: Add support for all_saltenvs parameter (refs: `#51661`_, `#51597`_)
