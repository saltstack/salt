...
The `yum <https://github.com/saltstack/salt-contrib/blob/master/modules/yumpkg.py>`
:doc:`pkg <https://github.com/saltstack/salt-contrib/blob/master/modules/yumpkg.py>`
modules gained Scientific Linux support.
