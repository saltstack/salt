...
Salt's linting has two major dependencies: pylint_ and saltpylint_
Linting should be done using :ref:`nox <getting_set_up_for_tests>`,
which is how pull requests are checked.
