...
encountering a problem where too many minions are re-authorizing against the Master, you need
to recalibrate your setup. Try reducing the rate of re-authorizing events, such as a Master restart,
