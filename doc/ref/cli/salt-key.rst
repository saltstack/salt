...
.. option:: -r REJECT, --reject=REJECT
    ...
    addition to pending keys). Globs are supported. It may cause dramatic
    performance salt-master degradation. See `performance guide <https://docs.saltproject.io/en/latest/topics/tutorials/intro_scale.html#too-many-minions-re-authing>` for details
