...
When I run *test.ping*  why do the Minions that aren't responding return anything? Returning ``False`` would be helpful.  
------------------------------------------------------------------------------------------------------------------------------------------------------ 

When you run :mod:`test.ping <salt.modules.test.ping>` the Master tells Minions
