...
If Exist "%BinDir%\Lib\site-packages\salt\modules\selinux.py" ^
    del /Q "%BinDir%\Lib\site-packages\salt\modules\selinux.*" 1>nul
...
If Exist "%BinDir%\Lib\site-packages\salt\modules\smbios.py" ^
    del /Q "%BinDir%\Lib\site-packages\salt\modules\smbios.*" 1>nul
...
If Exist "%BinDir%\Lib\site-packages\salt\states\selinux.py" ^
    del /Q "%BinDir%\Lib\site-packages\salt\states\selinux.*" 1>nul
