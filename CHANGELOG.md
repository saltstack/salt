...
- Fixed `aptpkg.normalize_name` to respect architecture. (#49537)
...
- Fixed issue on `test=true` with retry. (#54501)
...
- Fixed keyword mismatch with `cassandra_cql` and `cassandra_cql_return`. (#56404)
...
- Added ability to use regex pattern with `ps.pgrep`. (#49598)
...
- Added new roster option `ssh_pre_flight`. (#56588)
